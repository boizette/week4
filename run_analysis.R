...
####1.1 load 6 data sets from 6 files in the subset data of current directory  
testactiv<-read.table("./data/y_test.txt",header=FALSE)
names(testactiv)<-"numactiv"
testvars<-read.table("./data/x_test.txt",header=FALSE)
testsubjects<-read.table("./data/subject_test.txt",header=FALSE)
names(testsubjects)<-"numsubject"

trainactiv<-read.table("./data/y_train.txt",header=FALSE)
names(trainactiv)<-"numactiv"
trainvars<-read.table("./data/x_train.txt",header=FALSE)
trainsubjects<-read.table("./data/subject_train.txt",header=FALSE)
...
textfeatures<-read.table("./data/features.txt",header=FALSE)
...
write.table(partiel,file="./data/partiel.txt",row.names=FALSE,sep=",",dec=".")
